...
const PRODUCTS = [
    ...
    { id: 'p4', name: 'Dell XPS 15', category: 'laptop', price: 150000, tags:['power-user', 'coding', 'design'] },
    { id: 'p5', name: 'Keychron K2', category: 'accessory', price: 7500, tags:['mechanical-keyboard', 'productivity'] }
];
